    ...
    messages: [
      {
        role: "system",
        content:
          `以下の[テキスト]を[制約]に従って[出力フォーマット](json形式)で出力してください。[制約]* 出力は[出力フォーマット]のみ出力してください。日時はYYYY/MM/DDで表示してください。* [出力フォーマット]以外の余計な文章は出力しないでください。[出力フォーマット]{ "店名": "〇〇スーパー", "日時": "YYYY/MM/DD", "項目": "食費", "明細": [{  "商品名": "テスト",  "金額": 1000}],"合計金額": 10000}`
      },
